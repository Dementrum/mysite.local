...
if (!isset($_SESSION['test']) and !isset($_POST['q'])) {
	//Если первый запуск , то инициализируем переменные
	$q = 0; // Номер текущего вопроса
	$title = 'Пройдите тест';
	} else {
		// Создаём сессионную переменную test, содержащую массив ответов
		if ($_POST['q'] != '1') 
...
<table width="50%" border="1" align='center'>
    ...
    <tr>
        <td align="center">
            <h1><?= $title ?></h1>
            <p><a href='/v2/index.php'>Прервать тест и вернуться на сайт</a></p>
        </td>
    </tr>
    <!-- Верхняя часть страницы -->
    <tr>
